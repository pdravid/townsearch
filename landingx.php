...
<body>
    ...
    <section id="about-us">
        <div class="container">
			...
			<div class="col-sm-6 col-md-12">
					<div class="media services-wrap wow fadeInDown" style=" background-color:#fff;border-radius:8px;border: 1px solid #111; box-shadow:5px 5px 5px gray; ">
						...
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
								...
								<div class="pull-left">
									<a href="#"><img class="media-object" src="theme/<?php echo $row2['shoplogo']; ?>" height="270px" style="margin-right:25px;" alt=""></a>
								</div>
			...
			<img src="theme/<?php echo $row1['discimg'];?>" style="height:180px;" /></div>
				...
				<div id="carousel-slider" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" align="center">
						<div class="item active">
							<img src="theme/<?php echo $row1['img1'];?>" style="height:280px;" class="img-responsive" alt=""> 
					   </div>
					   <div class="item">
							<img src="theme/<?php echo $row1['img2'];?>" style="height:280px;"class="img-responsive" alt=""> 
					   </div> 
					   <div class="item">
							<img src="theme/<?php echo $row1['img3'];?>" class="img-responsive" style="height:280px;" alt=""> 
					   </div> 
					</div>
