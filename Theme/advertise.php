...
if(isset($_POST['submit'])){
	...
	$insert_query = "update rest set discimg='images/$shoplogo' where mobno='$user_mobno'";
          ...
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		<div class="col-lg-9" style="box-shadow:5px 5px 5px 2px;gray;border-radius:5px;margin-left:10px;">
                             <h3><i class="fa fa-angle-right"></i>Advertisement image</h3></br>
          		<?php
					$ad_query=mysqli_query($con,"select discimg from rest where mobno='$user_mobno'");
					$run_ad=mysqli_fetch_array($ad_query);
					
				?>
				<img src="<?php echo $run_ad['discimg']; ?>" style="width:350px;height:180px;">
				<form method="post" action="advertise.php" enctype="multipart/form-data"><br>
