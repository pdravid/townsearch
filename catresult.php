...
<html lang="en">
<?php
include('connection.php');include('head.php'); 
$searchkey=filter_input(INPUT_GET,"menu");
/*$result4 = mysqli_query($con,"SELECT * FROM category where cid like '%$searchkey%' ");
$row4=mysqli_fetch_array($result4);
$searchkey=$row4['categorynm'];*/
?>
<script>
function showHint(str,str2) {
  ...
  xmlhttp.open("GET","resultfetch.php?key="+str+"&zone="+str2,true);
  xmlhttp.send();
}
</script>
