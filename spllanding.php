...
$vname=$_POST['vname'];
if(isset($_POST['vmobno'])){
	$vmobno=$_POST['vmobno'];
	mysqli_query($con,"insert into visitor(vname,mobno,vemail,shopno,date,time) values('$vname','$vmobno','','$tab','$date','$time')");
$chutz="<div class='alert alert-primary' align='center'><p style='font-size:22px;'>You will receive Message in short time. Thanks for Using our Service. </p></div>";
}
else
{
if(isset($_POST['vmail'])){
		$vmail=$_POST['vmail'];
	mysqli_query($con,"insert into visitor(vname,mobno,vemail,shopno,date,time) values('$vname','','$vmail','$tab','$date','$time')");
$chutz="<div class='alert alert-primary' align='center'><p style='font-size:22px;'>You will receive Mail in short time. Thanks for Using our Service. </p></div>";
	}
	else{
		$passes=0;
$chutz="<div class='alert alert-primary' align='center'><p style='font-size:22px;'>Something is Missing.Please try again for Using our Service. </p></div>";
	}
}
	...
	<div class="row"  style="padding-top:10px;" >
			...
			<div class="col-sm-6 col-md-10" >
					...
					<div class="btn-group">
						...
						<button class="btn btn-primary"><?php if(isset($vname)){echo $row2['mobno'];}else{echo "VIEW CONTACT";}?></button>
					</div>
